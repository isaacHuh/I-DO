...
class GameWindow(pyglet.window.Window):
	def __init__(self, *args, **kwargs):
		...
		window.width = default_screen.width
		window.height = default_screen.height
		...
		self.player_character = GameObject(window.width/2,window.height/2,'game_files/player.png')
		...
		self.player_bullet = 'game_files/bullet_red.png'
		self.player_bullet_spd = 200
		self.player_bullet_list = []

		enemy = resource.image('game_files/enemy_running.png')
		...
		self.enemy = 'game_files/enemy.png'
		self.enemy_spd = 50
		self.enemy_list = []
		self.enemy_count = 0
		self.num_enemies = 0
		...
		self.circle_black = 'game_files/circle_black.png'
		self.circle_white = 'game_files/circle_white.png'
		self.circle_list = []
		self.circle_count = 0
		self.circle_color = 0
	...
	def player_character_update(self, dt):
		...
		if self.sprite_change_occured:
			if self.player_moving:
				image = 'game_files/player_running.png'
			else:
				image = 'game_files/player_idle.png'
